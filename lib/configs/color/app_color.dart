...
const kPrimary = Color(0xff2845d1);

const kSecondry=Color(0xff023047);
...
const Color kAlertColor = Color(0xFFFF0000);
const Color kTransparentColor = Color(0x00FFFFFF);


const kPresentColor=Color(0xff009b62);
const kAbsentColor=Color(0xffcb4137);
const kLeaveColor=Color(0xffd29d03);
const kHolidayColor=Color(0xff2845d1);
const kNotSetColor=Color(0xff00a6ed);
